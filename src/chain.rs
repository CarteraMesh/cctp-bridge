...
//         #[case] expected: u64,
//     ) {
//         assert_eq!(chain.confirmation_average_time_seconds().unwrap(),
// expected);     }

//     #[test]
//     fn test_confirmation_average_time_seconds_unsupported_chain() {
//         let result =
// NamedChain::BinanceSmartChain.confirmation_average_time_seconds();
...
//     fn test_cctp_domain_id_supported_chains(#[case] chain: NamedChain,
// #[case] expected: u32) {         assert_eq!(chain.cctp_domain_id().unwrap(),
// expected);     }
...
// ARBITRUM_SEPOLIA_TOKEN_MESSENGER_ADDRESS)]     #[case(NamedChain::Avalanche,
// AVALANCHE_TOKEN_MESSENGER_ADDRESS)]     #[case(NamedChain::Base,
// BASE_TOKEN_MESSENGER_ADDRESS)]     #[case(NamedChain::BaseSepolia,
// BASE_SEPOLIA_TOKEN_MESSENGER_ADDRESS)]     #[case(NamedChain::Sepolia,
// ETHEREUM_SEPOLIA_TOKEN_MESSENGER_ADDRESS)]     #[case(NamedChain::Mainnet,
// ETHEREUM_TOKEN_MESSENGER_ADDRESS)]     #[case(NamedChain::Optimism,
// OPTIMISM_TOKEN_MESSENGER_ADDRESS)]     #[case(NamedChain::Polygon,
// POLYGON_CCTP_TOKEN_MESSENGER)]     #[case(NamedChain::Unichain,
// UNICHAIN_CCTP_TOKEN_MESSENGER)]
...
// BASE_SEPOLIA_MESSAGE_TRANSMITTER_ADDRESS)]     #[case(NamedChain::Sepolia,
// ETHEREUM_SEPOLIA_MESSAGE_TRANSMITTER_ADDRESS)]
...
//         let result =
// NamedChain::BinanceSmartChain.message_transmitter_address();         assert!
// (result.is_err());         assert!(matches!(
//             result.unwrap_err(),
//             CctpError::ChainNotSupported { .. }
//         ));
//     }
